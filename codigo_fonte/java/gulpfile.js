...
gulp.task('watch', function () {
    ...
    gulp.watch(config.app + 'scripts/**/*.js', ['inject:app']);
    gulp.watch([config.app + '*.html', config.app + 'content/css/*.css', config.app + 'app/**', config.app + 'i18n/**']).on('change', browserSync.reload);
});
